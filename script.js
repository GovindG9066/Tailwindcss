...
let addproduct=()=>{
    ...
    // product_container.classList.add("flex","w-full","border","dark:border-gray-700");
    // product_container.innerHTML=`<div class="hover:shadow-2xl border border-purple-500 hover:-translate-y-2 hover:translate-x-1 transition-all duration-150 ease-in-out w-full h-full p-3 m-2 rounded-lg">`
